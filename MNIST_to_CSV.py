...
# convert raw image and label files into csv output for training and testing datasets
# creates files mnist_test.csv and mnist_train.csv within the MNIST_data folder


def convert(image_file, label_file, output_file, n):
    ...
    # create rows with label and each pixel in the image with value 0-255
    for i in range(n):
        image = [ord(l.read(1))]
...
convert('MNIST_data/MNIST/raw/train-images-idx3-ubyte', 'MNIST_data/MNIST/raw/train-labels-idx1-ubyte',
        "MNIST_data/mnist_train.csv", 60000)
convert('MNIST_data/MNIST/raw/t10k-images-idx3-ubyte', 'MNIST_data/MNIST/raw/t10k-labels-idx1-ubyte',
...
# relabel columns with label and numbers 1x1 - 1x28, 2x1 - 2x28, up to 28x28 corresponding with image pixel location
new_columns = ['label',
...
df_train.to_csv('MNIST_data/mnist_train.csv', index=False)
df_test.to_csv('MNIST_data/mnist_test.csv', index=False)

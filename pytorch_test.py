...
#------------------------------#
# Initialize Network and wandb #
#------------------------------#
wandb.init(project="neural-net-using-pytorch-testing-results")
...
for epoch in range(num_epochs):
    ...
    wandb.log({'accuracy': check_accuracy(test_loader, model),
               'loss': stat.median(loss_values)})
...
# acc_plot(train_accuracy, 0)

# Test Accuracy over Epochs
# acc_plot(test_accuracy, 1)
